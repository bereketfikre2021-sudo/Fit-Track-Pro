...
function ProfileTab({ state, updateState }) {
  ...
  const fitnessLevel = resolveEffectiveFitnessLevel(formData)
  const experienceHint = formData.fitnessLevelManual
  ...
  return (
    <div className="p-4 md:p-6 pb-20 md:pb-6 max-w-2xl mx-auto space-y-3">
      ...
      {/* Experience Level (read-only — set at signup or auto-detected from membership) */}
      <AccordionCard
        icon={Zap}
